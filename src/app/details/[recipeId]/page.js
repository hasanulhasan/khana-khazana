    ...
    <section>
      <div class="grid grid-cols-12 container gap-8 justify-items-center">
        <div class="col-span-12 md:col-span-6">
          <img src="https://source.unsplash.com/Zh0mYmMBZjQ/600x600" alt=""
            class="w-full h-full rounded-lg object-contain" />
        </div>
        <div class="col-span-12 md:col-span-6 py-8 flex flex-col justify-center">
          <h2 class="font-semibold text-4xl lg:w-8/12 leading-10">White calzones with marinara sauce</h2>
          <p class="text-xs text-[#eb4a36] italic my-2">Breakfast and Brunch</p>
          <p class="text-gray-600 text-sm my-6 leading-6">Supermarket brands of ricotta contain stabilizers, which can
            give the
            cheese
            a gummy
            texture when baked.
            Check the label and choose ricotta made with as few ingredients as possible.</p>
          ...
          <div class="flex gap-4 justify-center divide-x my-12">
            ...
            <div class="flex-1 text-center">
              ...
              <p class="text-gray-500 text-sm">1 hour</p>
            </div>
            <div class="flex-1 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mx-auto">
